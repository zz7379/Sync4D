...
def draw_cams(all_cam, color="cool", axis=True, color_list=None, rgbpath_list=None, trans_y=None):
...
def trimesh_coarse_axis(
    ...
    if z_only:
        marker = trimesh.util.concatenate([axis_origin, z_axis])
    else:
