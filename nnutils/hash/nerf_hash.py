...
class NeRF(nn.Module):
    ...
    def __init__(
        ...
        self.camera_mlp = CameraMLP(rtmat, frame_info=frame_info, D=2, W=256,time_embedding=self.time_embedding)
    ...
    def forward(self, xyz, dir=None, frame_id=None, inst_id=None, get_density=True):
        ...
        with torch.cuda.amp.autocast(enabled=False):
            ...
            sdf = self.sdffield(xyz_embed)  # negative inside, positive outside
            if get_density:
